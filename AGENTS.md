...
> 当前版本：**v4.4.3**（schema_version `1.0` 信封 / `1.1` capabilities）。AI 接入前建议先 `--capabilities` 探测，再 `--self-check` 验证。

## 下载

- GitHub Release：https://github.com/cscb603/StarTap-Image-Shrinking-Tool/releases/tag/v4.4.3
