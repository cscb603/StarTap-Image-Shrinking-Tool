...
const APP_NAME: &str = "图片高速压缩工具 v4.0";
const CONFIG_FILE: &str = "image_compressor_config.toml";
...
impl ImageCompressorApp {
    ...
    fn start_processing(&mut self) {
        ...
        let _ = std::thread::spawn(move || {
            let processor_config = app_config_to_process_config(&config, None);
                        ...
                        .show(ui, |ui| {
                            ...
                            ui.vertical(|ui| {
                                ...
                                ui.horizontal(|ui| {
                                    ...
                                    ui.add_space(15.0);
                                    ui.radio_value(&mut self.config.mode, ProcessMode::HD, "🖼️ 高清无损 (5MB)");
                                    ui.add_space(15.0);
                                    ui.radio_value(&mut self.config.mode, ProcessMode::Custom, "🎛️ 自定义模式");
                                });
